...
const Privacy = ({user}) => {
  ...
  return (
    <div className="basis-[80%] bg-[--c60] z-10 overflow-y-scroll p-4 flex flex-col">
      ...
      <h2 className="text-center">Privacy Policy for HIPPOS App</h2>

      <p>
        This Privacy Policy describes how your personal information is
        collected, used, and shared when you use the HIPPOS mobile application
      ...
      <details>
        ...
        <ul>
          ...
          <li>
            ...
            unique device identifiers) when you access or use the App.
          </li>
          <li>
            Usage information (such as the features you use, the pages you
            visit, and the actions you take) to improve the App's functionality
            and user experience.
          </li>
        </ul>
      </details>
      <details>
        ...
        <ul>
          ...
          <li>
            Personalize your experience and improve the App's functionality.
          </li>
          <li>
          ...
          <li>
            Enforce the App's terms and conditions and protect against
      ...
      <details>
        ...
        <ul>
          ...
          <li>
            Third-party analytics providers to analyze usage patterns and
            trends.
          </li>
          <li>
            Law enforcement agencies, government authorities, or authorized
            third parties if required by law or to protect our rights, safety,
            or property.
          </li>
        </ul>
      </details>
      ...
      <details>
        ...
        <p>
          ...
          revised policy in the App. We encourage you to review this Privacy
      ...
      <details>
        ...
        <p>
          ...
          App's practices, please contact us at alemihai25@gmail.com.
        </p>
      </details>
      <p>
        By using the HIPPOS App, you acknowledge that you have read, understood,
        and agreed to these Privacy Policy. If you do not agree to any of these
        terms, please discontinue using the App.
      </p>
    </div>
  );
};
