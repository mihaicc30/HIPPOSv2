...
const PaymentComplete = ({ user, venueNtable, basketItems, computedBasket, setBasketItems }) => {
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  key={crypto.randomUUID()}
                >
                  <p className="text-start font-bold text-xl line-clamp-1">{item.qty} x {item.name}</p>
